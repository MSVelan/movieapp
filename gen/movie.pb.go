...
func (x *PutMetadataRequest) GetMovieId() string {
	if x != nil {
		return x.MovieId
	}
	return ""
...
const file_movie_proto_rawDesc = "" +
	...
	"\x12PutMetadataRequest\x12\x19\n" +
	"\bmovie_id\x18\x01 \x01(\tR\amovieId\x12%\n" +
	"\bmetadata\x18\x02 \x01(\v2\t.MetadataR\bmetadata\"\x15\n" +
	"\x13PutMetadataResponse\"<\n" +
...
var file_movie_proto_depIdxs = []int32{
	...
	5,  // 9: MetadataService.GetMetadata:output_type -> GetMetadataResponse
